...
//#643 vector(float slot) gettouchfinger (DP_UT_TOUCHFINGER) — Ubuntu Touch port
static void VM_CL_gettouchfinger(prvm_prog_t *prog)
{
	int slot, active;
	float nx, ny;
...
NULL,							// #641
VM_coverage,						// #642
VM_CL_gettouchfinger,				// #643 vector(float slot) gettouchfinger (DP_UT_TOUCHFINGER)
NULL
};
